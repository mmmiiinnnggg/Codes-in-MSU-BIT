...
int main()
{
    ...
    if((fp1=fopen("Amat4.m","r"))==NULL){
        printf("Cannot open AMat2\n");
        exit(0);
    }
    if((fp2=fopen("Lmat4Up.m","w+"))==NULL){
        printf("Cannot open LMatUp2\n");
        exit(0);
    }
    if((fp3=fopen("Umat4Up.m","w+"))==NULL){
        printf("Cannot open UMatUp2\n");
        exit(0);
    }
    if((fp4=fopen("Pmat4.m","w+"))==NULL){
    ...
    cout<<"Success! Please check the answer in Amat4.m, Lmat4.m, Umat4.m and Pmat4.m"<<endl;
