...
void recognizeR(float R[600000], FILE *fp1){
    //input of A
    char c;
    string str;
    c=fgetc(fp1);
    ...
    while(c!=']'){
        ...
        while(c!=';'){
            ...
            if(mat_i>mat_j);
            else R[makeIndex(mat_i,mat_j++)]=num;
...
int main()
{
    ...
    if((fp1=fopen("Amat11.m","r"))==NULL){
        printf("Cannot open AMat10\n");
        exit(0);
    }
    if((fp2=fopen("bvec11.m","r+"))==NULL){
        printf("Cannot open bvec10\n");
        exit(0);
    }

    if((fp3=fopen("xvec11.m","w+"))==NULL){
        printf("Cannot open xvec11\n");
        exit(0);
    }
    ...
    if( ((fp4=fopen("Qmat11.m","r"))!=NULL) && ((fp5=fopen("Rmat11.m","r"))!=NULL) ){
        recognizeA(Q,fp4);
        recognizeR(R,fp5);
    }

    else{
        if((fp4=fopen("Qmat11.m","w+"))==NULL){
            printf("Cannot open Qmat11\n");
            exit(0);
        }

        if((fp5=fopen("Rmat11.m","w+"))==NULL){
    ...
    cout<<"Success! Please check the answer in Amat11.m, bvec11.m and xvec11.m"<<endl;
